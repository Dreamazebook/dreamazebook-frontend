      ...
      <div style={{'--success-logo-app':`url(${SUCCESS_LOGO_APP})`} as React.CSSProperties} className='bg-[#F5E3E3] flex justify-center items-center h-screen relative bg-(image:--success-logo-app) bg-no-repeat md:bg-none'>
        <div className='bg-white p-10 md:px-[88px] md:pt-12 md:pb-16 text-[#222222] max-w-sm md:max-w-4xl mx-auto relative z-10'>
          ...
          <div className='relative'>
            <h2 style={{'--success-underline':`url(${SUCCESS_UNDERLINE})`} as React.CSSProperties} className='font-bold text-[25px] md:text-[40px] text-center bg-no-repeat [background-size:130px] bg-[150px_25px] md:bg-[330px_40px] md:[background-size:250px] bg-(image:--success-underline)'>
