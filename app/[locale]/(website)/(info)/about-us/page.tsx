    ...
    <main className="text-[#222222] text-[14px] md:text-[16px]">
      ...
      <AnimatedSection>
        <section
          ...
          className="max-w-5xl mt-[24px] mb-[48px] mx-[24px] p-[24px] md:p-20 bg-(image:--hero-image-mobile) md:bg-(image:--hero-image) bg-no-repeat bg-center bg-cover mx-auto flex flex-col justify-end md:justify-center h-[80vh] md:h-[440px]">
          <div>
            <h1 className="text-[28px] md:text-[40px] font-semibold leading-[32px] md:leading-[64px] lg:w-[75%]">At Dreamaze, we create storybooks where your child truly sees themselves as the hero.</h1>
            <p className=" mt-[24px]">
      ...
      <AnimatedSection>
        <section className="max-w-5xl mx-auto py-[48px] px-[24px]">
      ...
      <AnimatedSection>
        <section className="max-w-5xl mx-auto p-[24px]">
