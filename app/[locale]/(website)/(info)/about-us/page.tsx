    ...
    <main className="text-[#222222] text-[14px] md:text-[16px]">
      ...
      <AnimatedSection>
        <section
          ...
          <div>
            <h1 className="text-[28px] md:text-[40px] font-semibold leading-[32px] md:leading-[64px] lg:w-[70%]">At Dreamaze, we create storybooks where your child truly sees themselves as the hero.</h1>
            <p className=" mt-[24px]">
      ...
      <AnimatedSection>
        <section className="max-w-[1200px] mx-auto py-[48px] px-[24px] md:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center leading-[20px] md:leading-[24px] gap-[12px] md:gap-[48px]">
            <div>
              <div ref={textRef1} className="transition-all duration-500 origin-left text-scale-animation scale-100-focus">
                <p className=''>
              ...
              <div ref={textRef2} className="hidden md:block transition-all duration-500 origin-left text-scale-animation scale-80-dim mt-6">
                <p>
      ...
      <AnimatedSection>
        <section className="max-w-[1200px] mx-auto p-[24px] md:p-0">
          <h2 className='text-center text-[36px] md:text-[60px] text-primary font-semibold py-[48px]'>Made by Educators & Artists,<br className="hidden md:block"/>Crafted for Your Child</h2>
      ...
      <AnimatedSection>
        <section className="py-[48px] px-[24px] md:py-[88px] flex flex-col justify-center">
          <div className='text-center'>
            ...
            <Link className="bg-[#222] flex items-center justify-center gap-[10px] mx-auto md:w-[360px] mt-5 block text-[16px] p-[8px] rounded text-[#FCF2F2]" href={SURVEY_URL}>
      ...
      <AnimatedSection>
        <section className="bg-[#FCF2F2] py-[48px] px-[24x] md:py-[88px] flex flex-col gap-[24px] md:gap-[48px]">
            <h2 className="text-[24px] md:text-[40px] font-semibold text-center">Safe and Friendly<br className="md:hidden" /> for Little Hands</h2>
            <p className="md:text-center px-[24px]">
...
Our books come in three durable formats, each tested to withstand eager hands and everyday use.<br/> Sturdy, lasting, and designed with care— <br/>
<span className="font-semibold">ready for little hands to explore, again and again.</span>
            ...
            <Link className="bg-[#222] md:w-[360px] flex items-center justify-center gap-[10px] mx-auto text-center mt-5 block text-[16px] p-[8px] rounded text-[#FCF2F2]" href={BOOKS_URL}>
