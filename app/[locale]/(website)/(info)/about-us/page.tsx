    ...
    <main className="text-[#222222] text-[14px] md:text-[16px]">
      <AnimatedSection>
        <section
          ...
          className="max-w-[1200px] h-[640px] md:max-h-[440px] mt-[24px] mb-[48px] p-[24px] pt-0 md:p-20 bg-(image:--hero-image-mobile) md:bg-(image:--hero-image) bg-no-repeat bg-cover mx-[24px] md:mx-auto flex flex-col justify-end md:justify-center md:h-[440px]"
        >
          <div>
