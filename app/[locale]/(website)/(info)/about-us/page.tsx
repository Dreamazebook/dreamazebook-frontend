  ...
  return (
    <main className="text-[#222222] space-y-20 text-[14px] md:text-[16px]">
      ...
      <section
        ...
        className="max-w-5xl p-4 md:p-20 bg-(image:--hero-image-mobile) md:bg-(image:--hero-image) bg-no-repeat bg-center bg-cover mx-auto flex flex-col justify-end md:justify-center h-[80vh] md:min-h-[220px]">
        <div>
