    ...
    <div className="fixed bottom-0 left-0 right-0 bg-white z-50 md:hidden">
      <div className="flex h-[68px] items-center justify-between p-3 gap-6 max-w-full">
        ...
        <Link
          ...
          className={`bg-[#222222] text-[#F5E3E3] h-[44px] px-4 py-3 rounded-[4px] hover:bg-gray-800 text-[14px] leading-[20px] tracking-[0.25px] transition-colors flex items-center justify-center whitespace-nowrap flex-shrink-0 ${isLoading ? 'opacity-75 cursor-wait pointer-events-none' : ''}`}
        >
          {isLoading ? (
            <>
