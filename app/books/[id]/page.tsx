        ...
        <div className="min-h-screen bg-white">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="max-w-xl mx-auto p-12">
                ...
                {/* !需要根据数据库内容 */}
                <span className="text-sm text-gray-600 bg-gray-100 px-3 py-1 rounded">two people</span>
                <span className="text-sm text-gray-600 bg-gray-100 px-3 py-1 rounded">Mom & child</span>
                </div>
