...
export const generateOGMetaTags = (config: SEOPageConfig) => {
  return {
    ...
    'og:url': config.canonicalUrl || 'https://dreamazebook.com/en',
...
export const seoConfigs: Record<string, SEOPageConfig> = {
  home: {
    ...
    canonicalUrl: 'https://dreamazebook.com/en',
  },
  books: {
  ...
  aboutUs: {
    ...
    canonicalUrl: 'https://dreamazebook.com/en/about-us',
  },
  faq: {
    ...
    canonicalUrl: 'https://dreamazebook.com/en/faq',
  },
  contact: {
    ...
    canonicalUrl: 'https://dreamazebook.com/en/contact-us',
  },
  delivery: {
    ...
    canonicalUrl: 'https://dreamazebook.com/en/delivery-information',
  },
  terms: {
    ...
    canonicalUrl: 'https://dreamazebook.com/en/terms-and-conditions',
  },
  privacy: {
    ...
    canonicalUrl: 'https://dreamazebook.com/en/privacy-policy',
  },
  returnPolicy: {
    ...
    canonicalUrl: 'https://dreamazebook.com/en/return-policy',
  },
};
